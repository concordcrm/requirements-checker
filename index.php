<?php
  ...
  if (isset($_POST['databaseTest'])) {
      ...
      foreach (['db_hostname', 'db_port', 'db_username', 'db_password', 'db_name'] as $attribute) {
  ...
  <body>
    <div class="max-w-4xl m-auto">
      <div class="p-3">
        ...
        <h1 class="text-2xl leading-10 font-bold mt-10 text-gray-700">
        ...
        <div class="text-red-500 p-4 bg-red-50 border border-red-200 mb-8 mt-3 rounded-md text-sm">
          <div class="flex items-center">
            <div class="shrink-0">
              <svg class="h-8 w-8 text-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
        ...
        <?php } ?>
        <h4 class="text-lg my-5 text-gray-600 font-semibold">PHP Version</h4>
                  ...
                  <tbody class="bg-white divide-y divide-gray-200">
                    <tr>
                      ...
                      <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                        <span class="inline-flex <?php echo $php['supported'] ? 'text-green-500' : 'text-orange-500'; ?>">
                        <?php
                          if ($php['supported']) {
                              include('./passes-icon.php');
                          }
                           echo $php['current'];
                          ?>
                        </span>
        ...
        <h4 class="text-lg mb-5 mt-10 text-gray-600 font-semibold">Required PHP Extensions</h4>
        <div class="flex flex-col">
          <div class="-my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
            <div class="py-2 align-middle inline-block min-w-full sm:px-6 lg:px-8">
              <div class="shadow-sm overflow-hidden border border-gray-200 sm:rounded-lg">
                <table class="min-w-full divide-y divide-gray-200">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                        <span class="inline-flex <?php echo $enabled ? 'text-green-500' : 'text-orange-500'; ?>">
                        <?php
                          if ($enabled) {
                              include('./passes-icon.php');
                          }
        ...
        <h4 class="text-lg mb-5 mt-10 text-gray-600 font-semibold">Recommended PHP Extensions</h4>
        <div class="flex flex-col">
          <div class="-my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
            <div class="py-2 align-middle inline-block min-w-full sm:px-6 lg:px-8">
              <div class="shadow-sm overflow-hidden border border-gray-200 sm:rounded-lg">
        ...
        <h4 class="text-lg mb-5 mt-10 text-gray-600 font-semibold">Required PHP Functions</h4>
        <div class="flex flex-col">
          <div class="-my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
            <div class="py-2 align-middle inline-block min-w-full sm:px-6 lg:px-8">
              <div class="shadow-sm overflow-hidden border border-gray-200 sm:rounded-lg">
        ...
        <h4 class="text-lg mt-5 text-gray-600 font-semibold">Database <span class="text-sm text-gray-400">recommended check</span></h4>
        ...
        <p class="text-red-500 p-4 bg-red-50 border border-red-200 mb-5 mt-3 rounded-md text-sm">
        ...
        <?php
                  ...
                  if (! $db->testVersion('5.6')) {
                      $dbHasErrors = true; ?>
        <div class="text-red-500 p-4 bg-red-50 border border-red-200 mb-5 mt-3 rounded-md text-sm">
          Concord CRM requires at leat MySQL 5.6 version. Your servers uses MySQL: <?php echo $db->getVersion(); ?>
        </div>
        <?php
                  } else {
                      $hasTestError = false;
              ...
              if (!$dbHasErrors) {
                  echo '<div class="flex text-green-500 p-4 bg-green-50 border border-green-200 mb-5 mt-3 rounded-md text-sm">';
                  include('passes-icon.php');
                  echo '<p class="ml-2">
          Your database passes the tests, as a tip, if you are going to install Concord CRM, you can use the same database, user and password since you already have them configured.
          </p>
          </div>';
              }
          }
        ...
        <form method="POST" action="index.php">
          ...
          <div class="bg-white p-7 shadow-sm border border-gray-200 sm:rounded-lg">
              ...
              <div class="space-y-6 sm:space-y-5">
                <div class="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start">
                  ...
                  <div class="mt-1 sm:mt-0 sm:col-span-2">
                    <input
                      type="text"
                      value="<?php echo $_POST['db_hostname'] ?? 'localhost'; ?>"
                      name="db_hostname"
                ...
                <div class="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start sm:border-t sm:border-gray-200 sm:pt-5">
                  ...
                  <div class="mt-1 sm:mt-0 sm:col-span-2">
                    <input
                      type="text"
                      value="<?php echo $_POST['db_port'] ?? '3306'; ?>"
                      name="db_port"
                      class="appearance-none outline-none bg-white text-sm block w-full rounded-md border-2 border-gray-300 py-2.5 px-3 shadow-sm focus:border-indigo-500"
                ...
                <div class="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start sm:border-t sm:border-gray-200 sm:pt-5">
                  <label for="inputDatabasePassword" class="block text-sm font-medium text-gray-700 sm:mt-px sm:pt-2">
                  <span class="text-red-600 text-sm mr-1">*</span>Database Password
                  </label>
                  <div class="mt-1 sm:mt-0 sm:col-span-2">
                    <input
                      type="password"
            ...
            <div class="text-right">
              <button type="submit" class="mt-10 inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
              Test Database
              </button>
            </div>
          </div>
